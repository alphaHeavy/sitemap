...
tests :: TestTree
tests = testGroup "All Tests" [testYahooFinance, testYahooFinanceUrls, testBloombergNews,testCnbcNews,testMarketWatchNews,testMarketWatch,testSeekingAlphaNews,testMarketWatchSearch]
